...
def cli_main(args):
    ...
    trainer = pl.Trainer(
        ...
        log_every_n_steps=args.log_every_n_steps if hasattr(args, "log_every_n_steps") else 50,
...
def build_args():
    ...
    # Model config
    parser = VarNetModule1.add_model_specific_args(parser)
    parser.set_defaults(
        num_cascades=8,
        pools=4,
        chans=18,
    ...
    # Set default checkpoint if one exists
