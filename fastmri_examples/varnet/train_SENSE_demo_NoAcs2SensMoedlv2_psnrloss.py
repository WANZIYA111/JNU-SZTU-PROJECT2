...
from fastmrinew.pl_modules import FastMriDataModuleSENSE_noacs as FastMriDataModule, SENSEModule_psnrloss_noacs as SENSEModule
...
def build_args():
    ...
    default_root_dir = fetch_dir("log_path", path_config) / "sense_train_psnr_loss_noacs_weight" / "sense_demo"
    ...
    args.default_root_dir = fetch_dir("log_path", path_config) / f"exp_{args.racc}_sense_train_psnr_loss_noacs_weight" / "sense_demo"
