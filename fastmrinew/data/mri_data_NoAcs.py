...
class SliceDataset_NoAcs(torch.utils.data.Dataset):
    """
    ...
    def __getitem__(self, i: int):
        ...
        if self.transform is None:
            sample = (kspace, ACS_KSPACE,mask, target, attrs, fname.name, dataslice)
        else:
            sample = self.transform(kspace, ACS_KSPACE,mask, target, attrs, fname.name, dataslice)
